...
UAttributes o-- "0..1" UPriority : priority
...
--
*MUST* be set to `UMessageType.Publish`.
--
...
--
*MUST* be set to `UMessageType.Notification`.
--
|`source`
|xref:uri.adoc[UUri]
|yes
...
--
*MUST* be set to `UMessageType.RpcRequest`.
--
...
--
* *MUST* be set to `UPriority.CS4` or higher.
--
...
--
*MUST* be set to `UMessageType.RpcResponse`.
--
