...
| 2
a| *MUST* be set to the bytes representing the link:../up-core-api/uprotocol/v1/uattributes.proto[protobuf encoding of the UAttributes object]
...
[cols="1,1"]
|===
| UPriority | Zenoh Message Priority
